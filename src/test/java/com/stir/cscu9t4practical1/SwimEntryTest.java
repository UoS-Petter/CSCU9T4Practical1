...
public class SwimEntryTest {
	...
	public void testGetType() {
		...
		String result = instanceA.getType();
		assertEquals(expResultA, result);

		SwimEntry instanceB = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, 3, "in a pool");
		String expResultB = "in a pool";
		String resultb = instanceB.getType();
	...
	public void testGetEntry() {
		...
		String expResult = "Alice swam 3.0 m outdoors in 0:16:7 on 1/2/2003\n";
